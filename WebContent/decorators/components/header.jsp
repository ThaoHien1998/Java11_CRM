								...
								<div class="navbar-notifications-menu__content"
									...
									<div class="py-2">
										...
										<div class="dropdown-item d-flex">
											...
											<div class="flex">
												Người dùng mới <a href="#">Trần Minh</a> đã đăng ký tài
												khoản<br /> <small class="text-muted">1 giờ trước.</small>
											</div>
										</div>
										<div class="dropdown-item d-flex">
											<div class="mr-3">
						...
						<li class="nav-item dropdown"><a href="#account_menu"
							...
							<div id="account_menu" class="dropdown-menu dropdown-menu-right">
								...
								<a class="dropdown-item active" href="<c:url value="" />">
									Dashboard </a> <a class="dropdown-item" href="<c:url value="" />">
									My profile </a> <a class="dropdown-item" href="<c:url value="" />">
									Edit account </a>
								<div class="dropdown-divider"></div>
